...
If Index = 0 Then 'attack
    MsgBox "Choosing [none/one-shot] will assume each mob can be killed instantly (but 3 mobs, for example, would take 3 rounds " _
                & "[area attack calculations planned for a future release])." _
