...
- FIX: Removed hardcoded quarterstaff and dagger for staff classes in GreaterMUD  
...
- FIX: Weapon saved to file wasn't showing blue (for convenience) when a different weapon is EQ'd but yet saved  
