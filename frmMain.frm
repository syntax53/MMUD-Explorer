...
Private Sub lblMonMagic_Click()
If chkMonMagic.Value = 1 Then
    chkMonMagic.Value = 0
    Call chkMonMagic_Click
Else
    chkMonMagic.Value = 1
    Call chkMonMagic_Click
    txtMonMagic.SetFocus
End If
End Sub
...
cmbArmourWorn.AddItem "Everywhere"
...
Private Sub txtMonMagic_GotFocus()
Call SelectAll(txtMonMagic)
End Sub
