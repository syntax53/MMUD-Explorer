...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame framNav 
      ...
      Begin VB.ComboBox cmbWeaponMagicLevel 
         Height          =   315
         ItemData        =   "frmMain.frx":0D6E
         Left            =   7860
         List            =   "frmMain.frx":0D70
         Style           =   2  'Dropdown List
         TabIndex        =   38
         Top             =   465
         Width           =   795
   ...
   Begin VB.Frame framNav 
      ...
      Begin VB.ComboBox cmbSpellContainsAbil 
         Height          =   315
         ItemData        =   "frmMain.frx":0D72
         Left            =   6900
         List            =   "frmMain.frx":0D74
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   800
         Top             =   480
      ...
      Begin VB.ComboBox cmbSpellAttackType 
         Height          =   315
         ItemData        =   "frmMain.frx":0D76
         Left            =   9060
         List            =   "frmMain.frx":0D78
         Style           =   2  'Dropdown List
         TabIndex        =   802
         Top             =   480
         Width           =   1095
      ...
      Begin VB.ComboBox cmbSpellTarget 
         Height          =   315
         ItemData        =   "frmMain.frx":0D7A
         Left            =   10260
         List            =   "frmMain.frx":0D7C
         Style           =   2  'Dropdown List
         TabIndex        =   804
         Top             =   480
         Width           =   1095
...
MsgBox "The DMG/Mana column will not update live from the global filter, " _
    & "but if you specify your level in the global filter and then re-apply the spell filter, " _
    & "it will take your level into account when calculating the spell's formula.", vbInformation
End Sub
...
Dim bClassOK As Boolean, bFiltered As Boolean, nAbility As Integer
...
Dim bClassOK As Boolean, bStaff As Boolean, bHasAbility As Boolean
...
Dim RoomExits As RoomExitType, sMegaCode As String
